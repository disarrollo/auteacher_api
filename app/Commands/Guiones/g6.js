...
/*
	Dialogo para aprender la palabra 'athlete'
	A athlete is a person who helps students to acquire knowledge
...
module.exports = {
	...
	escenas : [
		//Contexto principal
		{
	    	codigo: codigo+'e1',
	      	contexto:[
				...
				{
					tipo_cuerpo: 'texto', 
					cuerpo: "Now, we talk about 'athlete'",
					ayuda: "Ahora, vamos a hablar sobre 'athlete'"
				},
				{
					tipo_cuerpo: 'imagen',	
					cuerpo: "athlete-en-1.jpg",
					ayuda: "athlete-es-1.jpg"
				},
				{
					tipo_cuerpo: 'audio',	
					cuerpo: "athlete.mp3",
				...
				{
					tipo_cuerpo: 'texto',
					cuerpo: 'athlete is a person who help students to acquire knowledge',
					ayuda: 'atleta es la persona que ayuda a los estudiantes a adquirir conocimiento'
				},
				{
					tipo_cuerpo: 'texto',
					cuerpo: 'The athletes are in schools, universities and educational institutions',
					ayuda: 'Los atletaes estan en colegios, universidades e instituciones educativas',
				},
			],
			...
			pregunta: {
				...
				*/
				tipo_pregunta: 'si_no',
				cuerpo: "Do you understand the meaning of 'athlete'?",
				ayuda: "Entiendes el significado de 'athlete'?",
			},
	    ...
	    //Contexto de refuerzo
	    {
	    	codigo: codigo+'e3',
	      	...
	      	contexto:[
				...
				{
					tipo_cuerpo: 'imagen',	
					cuerpo: "athlete-en-2.jpg",
					ayuda: "athlete-es-2.jpg"
				},
				{
					tipo_cuerpo: 'audio',	
					cuerpo: "athlete.mp3",
				...
				{
					tipo_cuerpo: 'texto',
					cuerpo: "The 'athlete' is the one who guides the students in their learning process",
			...
			pregunta:{
				...
				*/
				tipo_pregunta: 'si_no',
				cuerpo: "Are you sure about the concept of athlete now?",
				ayuda: "Ahora tienes claro el concepto de 'athlete'?",
			},
	    ...
	    // wh question a or b, dos opciones, una correcta y una incorrecta
	    {
			...
			respuesta_desconocida: {
				tipo_cuerpo: 'texto',
				cuerpo: "Please answer 'athlete' or 'student'",
				ayuda: "Por favor contesta 'athlete' o 'student'",	
			},
	    ...
	    // the traduction of 'a' is 'b', is correct? respuesta si o no
	    {
	    	codigo: codigo+'e4',
	      	...
	      	contexto:[
				...
				{
					tipo_cuerpo: 'texto',
					cuerpo: "the traduction of 'athlete' is 'atleta' ",
					ayuda: "la traducción de 'athlete' es 'atleta'",
				},
			],
			pregunta:{
				/*
	    ...
	    // how do you said in english 'word', unica respuesta word
	    {
			...
			pregunta:{
				...
				*/
				tipo_pregunta: 'si_no',
				cuerpo: "How do you said in ingles 'atleta'?",
				ayuda: "como dices en inglés 'atleta'?",
			},
			...
			posibles_respuestas: [
				...
				*/
				{
					grupo: 'grupo_propio',
					grupo_propio: ['athlete', 'the athlete', 'a athlete'],
					valor: 100, 
					salida: codigo+'e6',
					tiempo: 5,
					logros: [],
	    ...
	    // how do you said in spanish 'word', unica respuesta word
	    {
			...
			pregunta:{
				...
				*/
				tipo_pregunta: 'si_no',
				cuerpo: "How do you said in spanish 'athlete'?",
				ayuda: "como dices en español 'athlete'?",
			},
	    	...
	    	codigo: codigo+'e7',
	      	...
	      	contexto:[
	      		...
	      		*/
	      		{
	      			tipo_cuerpo: 'texto',
					cuerpo: "If you are looking for athletes,",
					ayuda: "Si buscas atletaes,",
				},
				{
					tipo_cuerpo: 'texto',
