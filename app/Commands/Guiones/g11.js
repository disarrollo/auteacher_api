...
/*
	Dialogo para aprender la palabra 'flight attendant'
	A flight attendant is a person who helps students to acquire knowledge
	...
	escenas : [
		//Contexto principal
		{
	    	codigo: codigo+'e1',
	      	contexto:[
				...
				{
					tipo_cuerpo: 'texto', 
					cuerpo: "Now, we talk about 'flight attendant'",
					ayuda: "Ahora, vamos a hablar sobre 'flight attendant'"
				},
				{
					tipo_cuerpo: 'imagen',	
					cuerpo: "flight attendant-en-1.jpg",
					ayuda: "flight attendant-es-1.jpg"
				},
				{
					tipo_cuerpo: 'audio',	
					cuerpo: "flight attendant.mp3",
				},
				{
					tipo_cuerpo: 'texto',
					cuerpo: 'flight attendant is a person who help students to acquire knowledge',
					ayuda: 'auxiliar de vuelo es la persona que ayuda a los estudiantes a adquirir conocimiento'
				},
				{
					tipo_cuerpo: 'texto',
					cuerpo: 'The flight attendants are in schools, universities and educational institutions',
					ayuda: 'Los auxiliar de vueloes estan en colegios, universidades e instituciones educativas',
				},
			],
			...
			pregunta: {
				...
				*/
				tipo_pregunta: 'si_no',
				cuerpo: "Do you understand the meaning of 'flight attendant'?",
				ayuda: "Entiendes el significado de 'flight attendant'?",
			},
	    ...
	    //Contexto de refuerzo
	    {
	    	codigo: codigo+'e3',
	      	...
	      	contexto:[
				...
				{
					tipo_cuerpo: 'imagen',	
					cuerpo: "flight attendant-en-2.jpg",
					ayuda: "flight attendant-es-2.jpg"
				},
				{
					tipo_cuerpo: 'audio',	
					cuerpo: "flight attendant.mp3",
				...
				{
					tipo_cuerpo: 'texto',
					cuerpo: "The 'flight attendant' is the one who guides the students in their learning process",
			...
			pregunta:{
				...
				*/
				tipo_pregunta: 'si_no',
				cuerpo: "Are you sure about the concept of flight attendant now?",
				ayuda: "Ahora tienes claro el concepto de 'flight attendant'?",
			},
	    ...
	    // wh question a or b, dos opciones, una correcta y una incorrecta
	    {
			...
			pregunta:{
				...
				*/
				...
				cuerpo: "flight attendant or student?",
				ayuda: "auxiliar de vuelo o estudiante",
			},
			...
			respuesta_desconocida: {
				tipo_cuerpo: 'texto',
				cuerpo: "Please answer 'flight attendant' or 'student'",
				ayuda: "Por favor contesta 'flight attendant' o 'student'",	
			},
	    ...
	    // the traduction of 'a' is 'b', is correct? respuesta si o no
	    {
	    	codigo: codigo+'e4',
	      	...
	      	contexto:[
				...
				{
					tipo_cuerpo: 'texto',
					cuerpo: "the traduction of 'flight attendant' is 'auxiliar de vuelo' ",
					ayuda: "la traducción de 'flight attendant' es 'auxiliar de vuelo'",
				},
			],
			pregunta:{
				/*
	    ...
	    // how do you said in english 'word', unica respuesta word
	    {
			...
			pregunta:{
				...
				*/
				tipo_pregunta: 'si_no',
				cuerpo: "How do you said in ingles 'auxiliar de vuelo'?",
				ayuda: "como dices en inglés 'auxiliar de vuelo'?",
			},
			...
			posibles_respuestas: [
				...
				*/
				{
					grupo: 'grupo_propio',
					grupo_propio: ['flight attendant', 'the flight attendant', 'a flight attendant'],
					valor: 100, 
					salida: codigo+'e6',
					tiempo: 5,
					logros: [],
	    ...
	    // how do you said in spanish 'word', unica respuesta word
	    {
			...
			pregunta:{
				...
				*/
				tipo_pregunta: 'si_no',
				cuerpo: "How do you said in spanish 'flight attendant'?",
				ayuda: "como dices en español 'flight attendant'?",
			},
	    	...
	    	codigo: codigo+'e7',
	      	...
	      	contexto:[
	      		...
	      		*/
	      		{
	      			tipo_cuerpo: 'texto',
					cuerpo: "If you are looking for flight attendants,",
					ayuda: "Si buscas auxiliar de vueloes,",
				},
				{
					tipo_cuerpo: 'texto',
	    ...
	    // Negacion, respuesta falso o verdadero
	    {
	    	codigo: codigo+'e8',
	      	...
	      	contexto:[
				...
				{
					tipo_cuerpo: 'texto',
					cuerpo: "He is not a flight attendant",
					ayuda: "El no es un auxiliar de vuelo",
				},
			],
			pregunta:{
				/*
