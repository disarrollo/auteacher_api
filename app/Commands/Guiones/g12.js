...
/*
	Dialogo para aprender la palabra 'chef'
	A chef is a person who helps students to acquire knowledge
	...
	escenas : [
		//Contexto principal
		{
	    	codigo: codigo+'e1',
	      	contexto:[
				...
				{
					tipo_cuerpo: 'texto', 
					cuerpo: "Now, we talk about 'chef'",
					ayuda: "Ahora, vamos a hablar sobre 'chef'"
				},
				{
					tipo_cuerpo: 'imagen',	
					cuerpo: "chef-en-1.jpg",
					ayuda: "chef-es-1.jpg"
				},
				{
					tipo_cuerpo: 'audio',	
				...
				{
					tipo_cuerpo: 'texto',
					cuerpo: 'chef is a person who help students to acquire knowledge',
					ayuda: 'chef es la persona que ayuda a los estudiantes a adquirir conocimiento'
				},
				{
					tipo_cuerpo: 'texto',
					cuerpo: 'The chefs are in schools, universities and educational institutions',
					ayuda: 'Los chefes estan en colegios, universidades e instituciones educativas',
				},
			],
			...
			pregunta: {
				...
				*/
				tipo_pregunta: 'si_no',
				cuerpo: "Do you understand the meaning of 'chef'?",
				ayuda: "Entiendes el significado de 'chef'?",
			},
	    ...
	    //Contexto de refuerzo
	    {
	    	codigo: codigo+'e3',
	      	...
	      	contexto:[
				...
				{
					tipo_cuerpo: 'texto',
					cuerpo: "The 'chef' is the one who guides the students in their learning process",
			...
			pregunta:{
				...
				*/
				tipo_pregunta: 'si_no',
				cuerpo: "Are you sure about the concept of chef now?",
				ayuda: "Ahora tienes claro el concepto de 'chef'?",
			},
	    ...
	    // wh question a or b, dos opciones, una correcta y una incorrecta
	    {
			...
			pregunta:{
				...
				*/
				...
				cuerpo: "chef or student?",
				ayuda: "chef o estudiante",
			},
			...
			respuesta_desconocida: {
				tipo_cuerpo: 'texto',
				cuerpo: "Please answer 'chef' or 'student'",
				ayuda: "Por favor contesta 'chef' o 'student'",	
			},
	    ...
	    // the traduction of 'a' is 'b', is correct? respuesta si o no
	    {
	    	codigo: codigo+'e4',
	      	...
	      	contexto:[
				...
				{
					tipo_cuerpo: 'texto',
					cuerpo: "the traduction of 'chef' is 'chef' ",
					ayuda: "la traducción de 'chef' es 'chef'",
				},
			],
			pregunta:{
				/*
	    ...
	    // how do you said in english 'word', unica respuesta word
	    {
			...
			pregunta:{
				...
				*/
				tipo_pregunta: 'si_no',
				cuerpo: "How do you said in ingles 'chef'?",
				ayuda: "como dices en inglés 'chef'?",
			},
			...
			posibles_respuestas: [
				...
				*/
				{
					grupo: 'grupo_propio',
					grupo_propio: ['chef', 'the chef', 'a chef'],
					valor: 100, 
					salida: codigo+'e6',
					tiempo: 5,
					logros: [],
	    ...
	    // how do you said in spanish 'word', unica respuesta word
	    {
			...
			pregunta:{
				...
				*/
				tipo_pregunta: 'si_no',
				cuerpo: "How do you said in spanish 'chef'?",
				ayuda: "como dices en español 'chef'?",
			},
	    	...
	    	codigo: codigo+'e7',
	      	...
	      	contexto:[
	      		...
	      		*/
	      		{
	      			tipo_cuerpo: 'texto',
					cuerpo: "If you are looking for chefs,",
					ayuda: "Si buscas chefes,",
				},
				{
					tipo_cuerpo: 'texto',
	    ...
	    // Negacion, respuesta falso o verdadero
	    {
	    	codigo: codigo+'e8',
	      	...
	      	contexto:[
				...
				{
					tipo_cuerpo: 'texto',
					cuerpo: "He is not a chef",
					ayuda: "El no es un chef",
				},
			],
			pregunta:{
				/*
	    ...
	    // What do you see?, image - única respuesta 'word or sentence'
	    {
			...
			posibles_respuestas: [
				...
				*/
				{
					grupo: 'grupo_propio',
					grupo_propio: ['chef', 'a chef', 'the chef','is a chef', 'he is a chef', "he's a chef"],
					valor: 100, 
