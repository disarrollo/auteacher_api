		...
		//Contexto principal
		{
	    	codigo: codigo+'e1',
	      	contexto:[
				...
				{
					tipo_cuerpo: 'texto', 
					cuerpo: "Now, we talk about 'manager'",
				...
				{
					tipo_cuerpo: 'texto',
					cuerpo: 'manager is a person who help students to acquire knowledge',
					ayuda: 'administrador es la persona que ayuda a los estudiantes a adquirir conocimiento'
				},
				{
					tipo_cuerpo: 'texto',
					cuerpo: 'The managers are in schools, universities and educational institutions',
					ayuda: 'Los administradores estan en colegios, universidades e instituciones educativas',
				},
			],
	    ...
	    //Contexto de refuerzo
	    {
	    	codigo: codigo+'e3',
	      	...
	      	contexto:[
				...
				{
					tipo_cuerpo: 'texto',
					cuerpo: "The 'manager' is the one who guides the students in their learning process",
			...
			pregunta:{
				...
				*/
				tipo_pregunta: 'si_no',
				cuerpo: "Are you sure about the concept of manager now?",
	    ...
	    // how do you said in english 'word', unica respuesta word
	    {
			...
			pregunta:{
				...
				*/
				...
				ayuda: "como dices en inglés 'administrador'?",
			},
	    ...
	    // how do you said in spanish 'word', unica respuesta word
	    {
			...
			pregunta:{
				...
				*/
				...
				ayuda: "como dices en español 'manager'?",
			},
