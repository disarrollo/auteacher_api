...
/*
	Dialogo para aprender la palabra 'architect'
	A architect is a person who helps students to acquire knowledge
	...
	escenas : [
		//Contexto principal
		{
	    	codigo: codigo+'e1',
	      	contexto:[
				...
				{
					tipo_cuerpo: 'texto', 
					cuerpo: "Now, we talk about 'architect'",
					ayuda: "Ahora, vamos a hablar sobre 'architect'"
				},
				{
					tipo_cuerpo: 'imagen',	
					cuerpo: "architect-en-1.jpg",
					ayuda: "architect-es-1.jpg"
				},
				{
					tipo_cuerpo: 'audio',	
					cuerpo: "architect.mp3",
				},
				{
					tipo_cuerpo: 'texto',
					cuerpo: 'architect is a person who help students to acquire knowledge',
					ayuda: 'arquitecto es la persona que ayuda a los estudiantes a adquirir conocimiento'
				},
				{
					tipo_cuerpo: 'texto',
					cuerpo: 'The architects are in schools, universities and educational institutions',
					ayuda: 'Los arquitectoes estan en colegios, universidades e instituciones educativas',
				},
			],
			...
			pregunta: {
				...
				*/
				tipo_pregunta: 'si_no',
				cuerpo: "Do you understand the meaning of 'architect'?",
				ayuda: "Entiendes el significado de 'architect'?",
			},
	    ...
	    //Contexto de refuerzo
	    {
	    	codigo: codigo+'e3',
	      	...
	      	contexto:[
				...
				{
					tipo_cuerpo: 'imagen',	
					cuerpo: "architect-en-2.jpg",
					ayuda: "architect-es-2.jpg"
				},
				{
					tipo_cuerpo: 'audio',	
					cuerpo: "architect.mp3",
				...
				{
					tipo_cuerpo: 'texto',
					cuerpo: "The 'architect' is the one who guides the students in their learning process",
			...
			pregunta:{
				...
				*/
				tipo_pregunta: 'si_no',
				cuerpo: "Are you sure about the concept of architect now?",
				ayuda: "Ahora tienes claro el concepto de 'architect'?",
			},
	    ...
	    // wh question a or b, dos opciones, una correcta y una incorrecta
	    {
			...
			pregunta:{
				...
				*/
				...
				cuerpo: "architect or student?",
				ayuda: "arquitecto o estudiante",
			},
			...
			respuesta_desconocida: {
				tipo_cuerpo: 'texto',
				cuerpo: "Please answer 'architect' or 'student'",
				ayuda: "Por favor contesta 'architect' o 'student'",	
			},
	    ...
	    // the traduction of 'a' is 'b', is correct? respuesta si o no
	    {
	    	codigo: codigo+'e4',
	      	...
	      	contexto:[
				...
				{
					tipo_cuerpo: 'texto',
					cuerpo: "the traduction of 'architect' is 'arquitecto' ",
					ayuda: "la traducción de 'architect' es 'arquitecto'",
				},
			],
			pregunta:{
				/*
	    ...
	    // how do you said in english 'word', unica respuesta word
	    {
			...
			pregunta:{
				...
				*/
				...
				ayuda: "como dices en inglés 'arquitecto'?",
			},
	    ...
	    // how do you said in spanish 'word', unica respuesta word
	    {
			...
			pregunta:{
				...
				*/
				tipo_pregunta: 'si_no',
				cuerpo: "How do you said in spanish 'architect'?",
				ayuda: "como dices en español 'architect'?",
			},
