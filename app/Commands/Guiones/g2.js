...
module.exports = {
	...
	escenas : [
		//Contexto principal
		{
	    	codigo: codigo+'e1',
	      	contexto:[
				...
				{
					tipo_cuerpo: 'texto', 
					cuerpo: "Now, we talk about 'teacher'",
					ayuda: "Ahora, vamos a hablar sobre 'teacher'"
				},
				{
					tipo_cuerpo: 'imagen',	
					cuerpo: "teacher-en-1.jpg",
					ayuda: "teacher-es-1.jpg"
				},
				{
					tipo_cuerpo: 'audio',	
					cuerpo: "teacher.mp3",
				...
				{
					tipo_cuerpo: 'texto',
					cuerpo: 'teacher is a person who help students to acquire knowledge',
					ayuda: 'profesor es la persona que ayuda a los estudiantes a adquirir conocimiento'
				},
				{
					tipo_cuerpo: 'texto',
					cuerpo: 'The teachers are in schools, universities and educational institutions',
			...
			pregunta: {
				...
				*/
				tipo_pregunta: 'si_no',
				cuerpo: "Do you understand the meaning of 'teacher'?",
				ayuda: "Entiendes el significado de 'teacher'?",
			},
	    ...
	    //Contexto de refuerzo
	    {
	    	codigo: codigo+'e3',
	      	...
	      	contexto:[
				...
				{
					tipo_cuerpo: 'imagen',	
					cuerpo: "teacher-en-2.jpg",
					ayuda: "teacher-es-2.jpg"
				},
				{
					tipo_cuerpo: 'audio',	
					cuerpo: "teacher.mp3",
				...
				{
					tipo_cuerpo: 'texto',	
					cuerpo: "The 'teacher' is the person who is standing in front of the students in the classroom",
					ayuda: "'teacher' es la persona que está de pie en frente de los estudiantes en el salón de clase"
				},
				{
					tipo_cuerpo: 'texto',
					cuerpo: "The 'teacher' is the one who guides the students in their learning process",
					ayuda: "'teacher' es quien guia a los estudiantes en su proceso de aprendizaje"
				},
			],
			pregunta:{
				/*
				...
				*/
				tipo_pregunta: 'si_no',
				cuerpo: "Are you sure about the concept of teacher now?",
				ayuda: "Ahora tienes claro el concepto de 'teacher'?",
			},
	    ...
	    // wh question a or b, dos opciones, una correcta y una incorrecta
	    {
			...
			respuesta_desconocida: {
				tipo_cuerpo: 'texto',
				cuerpo: "Please answer 'teacher' or 'student'",
				ayuda: "Por favor contesta 'teacher' o 'student'",	
			},
	    ...
	    // the traduction of 'a' is 'b', is correct? respuesta si o no
	    {
	    	codigo: codigo+'e4',
	      	...
	      	contexto:[
				...
				{
					tipo_cuerpo: 'texto',
					cuerpo: "the traduction of 'teacher' is 'profesor' ",
					ayuda: "la traducción de 'teacher' es 'profesor'",
				},
			],
			pregunta:{
				/*
	    ...
	    // how do you said in english 'word', unica respuesta word
	    {
			...
			posibles_respuestas: [
				...
				*/
				{
					grupo: 'grupo_propio',
					grupo_propio: ['teacher', 'the teacher', 'a teacher'],
					valor: 100, 
					salida: codigo+'e6',
					tiempo: 5,
					logros: [],
	    ...
	    // how do you said in spanish 'word', unica respuesta word
	    {
			...
			pregunta:{
				...
				*/
				tipo_pregunta: 'si_no',
				cuerpo: "How do you said in spanish 'teacher'?",
				ayuda: "como dices en español 'teacher'?",
			},
	    	...
	    	codigo: codigo+'e7',
	      	...
	      	contexto:[
	      		...
	      		*/
	      		{
	      			tipo_cuerpo: 'texto',
					cuerpo: "If you are looking for teachers,",
	    ...
	    // What do you see?, image - única respuesta 'word or sentence'
	    {
			...
			posibles_respuestas: [
				...
				*/
				{
					grupo: 'grupo_propio',
					grupo_propio: ['teacher', 'a teacher', 'the teacher','is a teacher', 'he is a teacher', "he's a teacher"],
					valor: 100, 
